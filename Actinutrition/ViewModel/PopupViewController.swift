...
class PopupViewController: SWRevealViewController, SWRevealViewControllerDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        let logoImage : UIImage = UIImage(named: "nav_logo_acti")!
    ...
    {
        let defaultBackgroundColor : UIColor = UIColor.init(red: 132/255, green: 187/255, blue: 35/255, alpha: 1.0)
    ...
    {
        let phoneNumber = URL(string: "tel://+330481092284")!
